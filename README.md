...
感谢 新音乐API(https://api.nxvav.cn/api/music)提供的在线播放支持

## 📝 最近更新

### 2024-11-30
- ✨ 优化了API配置，网易云和QQ音乐使用新的音乐API接口
- ✨ 在搜索结果中显示音乐源标签，让用户可以清楚地看到每个结果来自哪个音乐源
- ✨ 修复了主题切换按钮样式，使其能跟着背景一起变色
- ✨ 实现了歌词全屏功能，提供更好的歌词阅读体验
- ✨ 优化了全屏歌词样式，包括文本颜色和背景透明度
- ✨ 支持网易云和QQ音乐的在线播放和下载
- ✨ 酷我和咪咕音乐继续使用旧的API接口
