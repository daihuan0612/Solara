...
- 🎨 密码界面：优化掉了输入密码时的白色衬底，现在密码输入框更自然，不会出现白色衬底飞出屏幕外的尴尬。2025.12.24
- 🎨 主题美学：内置亮/暗模式与玻璃拟态界面，根据当前曲目封面自动取色渲染沉浸式背景，具备沉浸体验。2025.12.24
...
- 📥 简化的质量选择：提供 MP3 和无损两种下载选项，MP3 自动选择最佳质量，无损保持原始音质。2025.12.24
- 🔄 增强了下载逻辑：添加了重试机制，提高了下载成功率，优化了错误处理和用户通知。2025.12.24
- ☁️ 轻量后端代理：通过 Cloudflare Pages Functions 统一聚合各数据源并处理音频跨域。
- 🔒 优化了PWA锁屏播放控制：修复了 iOS 上的兼容性问题，确保手动和自动切换歌曲时都能正常播放。2025.12.24
- 🛠️ 调试控制台：按下 Ctrl + D 呼出实时日志面板，便于排查接口或交互异常，增加了更多的日志内容。2025.12.24
- 🔧 增强的 API 请求：添加了重试机制，提高了 API 请求成功率。2025.12.24
- 🎯 优化的唱盘设计：唱盘封面占满整个唱盘托盘，提供更沉浸的视觉体验。2025.12.24
- 📱 改进了移动端体验：新增了白色主题的显示效果，增强了所有元素在各种颜色下的自适应。2025.12.24
