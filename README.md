...
## 🤝 参与贡献
#### 感谢  项目所有者：akudamatata 提供的优秀项目2025.12.24<br>
#### 感谢  GD音乐台(music.gdstudio.xyz)提供的免费API，虽然我没用，但是没有这个api就没有这个项目2025.12.24<br>
#### 感谢  来自Linux.do 牛就是牛@ufoo 大佬 https://linux.do/t/topic/942415 提供给项目所有者的灵感2025.12.24<br>

<br>

#### 🤝 我买了几个AI会员，又借遍了所有的主流AI的会员，公共迭代了40几次，<br>
####      共同给出了一个终极的解决锁屏状态下手动/自动切歌后，进度条动但是没声音的问题，<br> 
####      如果还没解决，后来者也不用尝试了，这是网页版PWA的极限了！！！
#### 🤝 更换了API服务，提升了稳定性和响应速度 2025.12.24
#### 🤝 优化了部分场景下取色不稳定的bug 2025.12.24
#### 🤝 增加了本地取色的代码，在api取色不稳当的情况下自动选择本地取色 2025.12.24
#### 🤝 修改了切换明/暗场景按钮也可以随背景变色，使界面观感更协调 2025.12.24
#### 🤝 优化了部分冗余代码，修改了部分不规范的代码 2025.12.24

<br>

## 🌟 主要特性
- 🎨 登录界面：优化了favicon1.png的容器，现在不会出现异色或者填不满的尴尬状态。2025.12.24
- 🎨 密码界面：优化掉了输入密码时的白色衬底，现在密码输入框更自然。2025.12.24
- 🎨 主题美学：内置亮/暗模式与玻璃拟态界面，根据当前曲目封面自动取色渲染沉浸式背景。2025.12.24
...
- 📥 简化的质量选择：提供MP3和无损两种下载选项，MP3自动选择最佳质量。2025.12.24
- 🔄 增强了下载逻辑：添加了重试机制，提高了下载成功率，优化了错误处理和用户通知。2025.12.24
- ☁️ 轻量后端代理：通过 Cloudflare Pages Functions 统一聚合各数据源并处理音频跨域。
- 🔒 优化了PWA锁屏播放控制：修复了iOS上的兼容性问题，确保添加到桌面后锁屏都能正常播放。2025.12.24
- 🛠️ 调试控制台：按下 Ctrl + D 呼出实时日志面板，增加了更多的日志内容。2025.12.24
- 🔧 增强的 API 请求：添加了重试机制，提高了 API 请求成功率。2025.12.24
- 🎯 优化的唱盘设计：唱盘封面占满整个唱盘托盘，提供更沉浸的视觉体验。2025.12.24
- 📱 改进了移动端体验：新增了所有元素在各种主题下的自适应。2025.12.24
...
## 🧭 探索雷达
- 探索雷达会在WYY随机「看下面↓」选歌填充播放列表，其它两个我屏蔽了，因为那两个并发搜索会被隔离一会儿。2025.12.24
- 探索雷达会在「流行、摇滚、古典音乐、民谣、电子、爵士、说唱、乡村、蓝调、R&B、金属、嘻哈、轻音乐」（我改了我自己喜欢的，你也可以改）等分类中随机挑选关键词，自动为播放列表补充新歌。
